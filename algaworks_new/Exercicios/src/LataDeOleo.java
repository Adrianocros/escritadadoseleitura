...
Vamos declarar as variáveis V, R e A como double e definir 
um valor qualquer para as variáveis de altura e de raio. 
...
public class LataDeOleo {
    public static void main(String[] args){
        ...
        System.out.println("O volume da lata de oleo é " + V + " M³");
    }
}
